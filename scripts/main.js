...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('http://localhost:3000/api-key')
        ...
        .then(data => {
            ...
            const oddsApiUrl = `https://api.the-odds-api.com/v4/sports/basketball_nba/odds?api_key=${apiKey}&regions=us,eu,us2,uk&markets=h2h,spreads,totals,player_threes&oddsFormat=american&dateFormat=iso`;
