...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('http://localhost:3000/odds-api-key')
        ...
        .then(data => {
            ...
            const oddsApiUrl = `https://api.the-odds-api.com/v4/sports/basketball_ncaab/odds?apiKey=${apiKey}&regions=us,eu,us2,uk,us_dfs,us_ex&markets=h2h,spreads,totals&oddsFormat=american&dateFormat=iso`;
